...
const projects = [
  ...
  { title: "SIP Express Plus", descId: "Solusi pengiriman barang B2B yang mudah, cepat, dan aman. Memberikan kualitas pelayanan terbaik agar barang kiriman sampai tujuan dengan aman dan tepat waktu.", descEn: "B2B delivery solution that is easy, fast, and secure. Providing the best quality service to ensure packages arrive safely and on time.", url: "https://plus.sipexpress.co.id/login", tags: ["Logistics", "B2B", "Delivery"], type: "Web Application", color: "from-orange-400 to-red-400", featured: false },
  { title: "MRBS Indorent", descId: "Meeting Room Booking System untuk manajemen ruang kerja dan penjadwalan yang efisien.", descEn: "Meeting Room Booking System for efficient workspace management and scheduling.", url: "https://mrbs.indorent.co.id/", tags: ["Booking System", "Enterprise", "Maintenance"], type: "Internal Tool", color: "from-violet-500 to-purple-500", featured: false },
  { title: "VOC Indorent", descId: "Platform Voice of Customer untuk mengumpulkan dan mengelola feedback serta survei kepuasan pelanggan.", descEn: "Voice of Customer platform for collecting and managing customer feedback and satisfaction surveys.", url: "https://voc.indorent.co.id/", tags: ["Customer Feedback", "Analytics", "Maintenance"], type: "Web Application", color: "from-teal-500 to-cyan-500", featured: false },
